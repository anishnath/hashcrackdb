...
public class WhirlpoolConsumer implements Runnable {

	protected BlockingQueue queue = null;
	protected Database db;

	public WhirlpoolConsumer(BlockingQueue queue, Database md5database) {
		this.queue = queue;
		this.db = md5database;
	}
	...
	public void run() {
		...
		try {
			...
			while (true) {
				...
				//System.out.println("whirlpool Consumer -- " + hexValue.toUpperCase());
